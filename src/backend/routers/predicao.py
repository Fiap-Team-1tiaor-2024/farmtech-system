...
def predicao():
    ...
    required_columns = ['area_total', 'latitude_plantio', 'longitude_plantio', 'qtde_insumo_total', 'valor_medido']
    ...
    if df.empty:
        return {"error": "Não há dados suficientes após remover NaNs para realizar a predição."}
